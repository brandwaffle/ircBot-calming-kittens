...
class CalmingKittens{
    ...
    public function check_commands( $username = '', $channel = '', $message = '' ){
        if( preg_match( '/^!calmdown/i', $message ) ){
            ircBot::send_channel_message( $channel, 'You seem stressed, ' . $username . '. Maybe you should look at kittens http://farm5.staticflickr.com/4060/4647807839_8206b541fb_z.jpg' );
        }
    }
}
